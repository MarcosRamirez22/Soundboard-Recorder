...
- Automatically convert incompatible multichannel recordings for better soundboard compatibility
- Multichannel volume compensation when converting sources with more than two channels
...
When multiple recording sources are mixed, Soundbyte Builder currently mixes them using:
